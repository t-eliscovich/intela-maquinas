...
# Con el nombre de la tabla adelante: adentro de un ON CONFLICT, «marca» sola
# es ambigua y Postgres no la acepta. Pasó en producción.
check("completar la ficha no pisa lo que ya esta cargado",
      "coalesce(maquina_ficha.marca, %s)" in _sql.get("sql", ""))
